...
namespace PostBoard.Server.Data.Migrations
{
    ...
    [Migration("20221105215342_CategoryPost")]
    partial class CategoryPost
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PostBoard.Server.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PostBoard.Server.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PostBoard.Server.Models.PostEntity", b =>
                {
                    b.HasOne("PostBoard.Server.Models.CategoryEntity", "Category")
                        .WithMany("Posts")
